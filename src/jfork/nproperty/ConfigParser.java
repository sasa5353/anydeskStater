...
public class ConfigParser
{
	 ...
	 * @throws IOException If configuration file does not exists or due to system IO errors.
	 */
	public static Properties parse(Object object, String path, boolean escape) throws InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException, IOException
	{
		return parse(object, new File(path), escape);
	}
	 ...
	 * @throws IOException If configuration file does not exists or due to system IO errors.
	 */
	public static Properties parse(Object object, File file, boolean escape) throws IOException, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException
	{
		Properties props;

		try (FileInputStream stream = new FileInputStream(file))
		{
			props = parse(object, stream, file.getPath(), escape);
		}
	 ...
	 * @throws IOException If configuration file does not exists or due to system IO errors.
	 */
	public static Properties parse(Object object, InputStream stream, String streamName, boolean escape) throws InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException, IOException
	{
		if (escape) {
		...
		p.load(stream);
		return parse0(object, p, streamName);
	}

	public static class PropertiesEx extends Properties {
	...
	@SuppressWarnings("unchecked")
	private static Properties parse0(Object object, PropertiesEx props, String path) throws IOException, IllegalAccessException, InstantiationException, NoSuchMethodException, InvocationTargetException
	{
		boolean callEvents = object instanceof IPropertyListener;
